        ...
        <div className="w-full flex flex-col gap-10">
            ...
            <ul className="w-full flex items-center justify-between">
                ...
                <li className="w-[250px] h-[250px] rounded-2xl border border-black flex flex-col items-center relative justify-between transition">
                    ...
                    <button className="w-[200px] h-[90px] transition translate-x-1 relative hover:bg-black group-hover:translate-x-full">
                        <div className="h-full w-[30px] bg-black ease origin-center transition-all duration-300 group-hover:h-64 ">
